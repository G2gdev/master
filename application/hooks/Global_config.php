...
class Global_config {
	...
	function load_config() {
		...
		$rejectedCount = $this->CI->orderlib->rejectedOrders();
		$this->CI->template->set('orderreject', $rejectedCount);
		$this->CI->template->set('ordercount', $ordercount);
		$todaysTicket = $this->CI->orderlib->getTodaysTickets();
		$remindorders = $this->CI->orderlib->getallReminderOrders();
		$this->CI->template->set('todaysTicket', $todaysTicket);
