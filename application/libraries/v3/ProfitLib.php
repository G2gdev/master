...
class ProfitLib {
    ...
    public function __construct() {
        ...
        $this->CI->load->model ( 'v3/profit/Profitmodel', 'profitmodel');
    }
    ...
    public function get_all_service($param, $with_service_tax) {
        return $this->CI->profitmodel->get_all_service($param, $with_service_tax); 
    }
