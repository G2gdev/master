...
class MechanicLib {
	...
	public function otpMatch($reg) {
		$this->CI->load->model ( 'v3/mechanic_model/Mechanic_model', 'mechanic_model' );
		$params = array ();
	...
	public function updatePassword($data) {
		$this->CI->load->model ( 'v3/mechanic_model/Mechanic_model', 'mechnic_model' );
	...
	{
		$this->CI->load->model ( 'v3/mechanic_model/Mechanic_model', 'check_mobile' );
	...
	public function sendGarageAssignedEmail($garageid,$data){
		...
		if(!empty($mec)){
			...
			$this->CI->pkemail->headline = 'New Order Assign |Garage2Ghar';
