...
function sendFCMPushNotificationSingle($registatoin_ids,$message,$title)
{
	...
	//define("GOOGLE_API_KEY", "AIzaSyCdJcFkDuhZGjFa16VYA4-HyTSp7wc30s8"); 	// GCM server key
	define("GOOGLE_API_KEY", "AIzaSyACSWiShG-2bOfsQbeBDWiDyNLs3ayqdGU");
	$headers = array(
...
function sendFCMPushNotificationMechanic($registatoin_ids,$message,$title)
{
	...
	//Google Cloud Messaging GCM API Key
	define("GOOGLE_API_KEY", "AIzaSyAGgKV867wxgV7NMIu7euAOmoKxelVgjHI"); 	// GCM server key
	//define("GOOGLE_API_KEY", "AIzaSyACSWiShG-2bOfsQbeBDWiDyNLs3ayqdGU");
	$headers = array(
			'Authorization: key=' . GOOGLE_API_KEY,
			'Content-Type: application/json'
...
function sendMultipleFCMPushNotificationMechanic($registatoin_ids,$message,$title){
	...
	//Google Cloud Messaging GCM API Key
	define("GOOGLE_API_KEY", "AIzaSyAGgKV867wxgV7NMIu7euAOmoKxelVgjHI"); 	// GCM server key
	//define("GOOGLE_API_KEY", "AIzaSyCcWjuxEJs3Kh5nn--UuPg1J60UAFbMo1s");
	$headers = array(
			'Authorization: key=' . GOOGLE_API_KEY,
			'Content-Type: application/json'
	);
