        	...
        	<div class="panel panel-default">
            	<div class="panel-heading">
              		...
              		<form action="<?php echo base_url()?>admin/report/business" method="post">
	              		<div class="panel panel-default">
		                   	<div class="panel-body">
	                            <div class="row" style="width: 70%;">
		                            <div class="col-md-6">
		                            	<input type="text" id="from_date" name="from_date" class="form-control" placeholder="From Date" value="<?php if(!empty($params['from_date'])){ echo date('d-m-Y',strtotime($params['from_date']));}?>" autocomplete="off" />
		                            </div>
		                            <div class="col-md-6">
		                            	<input type="text" id="to_date" name="to_date" class="form-control" placeholder="To Date" value="<?php if(!empty($params['to_date'])){ echo date('d-m-Y',strtotime($params['to_date']));}?>" autocomplete="off"/>
		                            </div>
	                          	</div>
	               	...
	               	<div class="panel panel-default">
	                   	<div class="panel-body">
			               	<div class="row">
			               		<div class="col-md-4">
		              				<label>Grage commission : <?php echo ' '.$orders['total_garagecomm']; ?></label>
		              			</div>
		              			<div class="col-md-4">
		              				<label>Vendor commission : <?php echo ' '.$orders['total_vendorcomm'] ; ?></label>
		              			</div>
		              			<div class="col-md-4">
		              				<label>Total Revenue : <?php echo ' '.$orders['total_revenue'];  ?></label>
		              			</div>
		              		</div>
		              	</div>
			        </div>
              	...
              	<?php
              		...
              		//unset variables from orders array
              		unset($orders['total_garagecomm']);            
              		unset($orders['total_vendorcomm']);
              		unset($orders['total_revenue']);
	              	...
	              	<table id="example1" class="display" cellspacing="0" width="100%">
				        ...
				        ?>
				            <tr>
				                ...
				                <td><?php echo $order['amount_received'];?> - <?php if($order['pay_mode'] == 1){?>Online<?php } else {?>Cash<?php } ?></td>
