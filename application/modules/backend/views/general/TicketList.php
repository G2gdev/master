...
<div id="page-wrapper">
	<div class="row">
		<div class="col-lg-12">
			<div class="btn-plus">
			<a href="<?php echo base_url();?>admin/general/ticket/new" target="_blank" class="btn btn-primary view-contacts bottom-margin">
								...
								<tr>                                     <td>										<?php echo $ticket['ticketid'];?>									 </td>									
									 <td>
										 <?php foreach ($status as $row) {
													if($ticket['status_id'] == $row['id']) {  echo $row['name'];
												}
											}
											?>
 									</td> 
			...
			<a  target="_blank" href="<?php echo base_url();?>admin/general/ticket/new" class="btn btn-primary view-contacts bottom-margin">
				<i class="fa fa-plus"></i> Ticket
			</a>
		</div>
	</div>
