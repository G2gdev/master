										...
										<div class="form-group" id="error-name">
											...
											<option value=""> Select Sub Category</option>	 
												<?php foreach ($subcategories as $category) { ?>	
													     <option value="<?php echo $category['id'];?>" <?php if($ticket['subcategory_id'] == $category['id']) {?>selected<?php }?>><?php echo $category['name'];?></option>		
												<?php }  ?>
														</select>
												</div>
										</div>
									...
									<div class="col-lg-6 margin-bottom-5">
										<div class="form-group" id="error-subject">
											...
											<div class="col-sm-10">
												...
												placeholder="other subject" value="<?php echo $ticket['subject']; ?>" />
											</div>
											<div class="messageContainer col-sm-10"></div>
										</div>
									</div>
										...
										<div class="form-group" id="error-assigned_to">
											...
											<div class="col-sm-10">
												<select name="ticket[assigned_to]" id="assigned_to" class="form-control">
													...
													<option value="<?php echo $acp['id'];?>" <?php if($ticket['assigned_to'] == $acp['id']) { ?>selected<?php } ?>><?php echo $acp['name'];?> </option>
													<?php } ?>
												</select>
											</div>
											<div class="messageContainer col-sm-10"></div>
