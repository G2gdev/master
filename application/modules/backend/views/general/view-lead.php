                                ...
                                <div class="panel-body">	
                                        <div class="form-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4 text-padding">
                                            	 	<div class="row ">
                                                     	<p> Subject : <?php echo $ticket1['subject']; ?></p>
                                                    </div> 
                                                    <div class="row">
                                                     	<p> Comment : <?php echo $ticket1['description']; ?></p>
                                                    </div>
                                                </div> 
                                                <div class="col-md-4 text-padding">
                                                     <div class="row">
                                                     	<p> Service/Spare : <?php echo $ticket1['services']; ?></p>
                                                    </div>
...
$("#comment-form").on("submit", function(){
 ...
 $('#executive_id').focus(function() {
     ...
     {		
			...
			$.post(base_url+"admin/general/change/executiveTicket", { id:ticketid, user:user }, function(data){
				if(data.status == 1) {
 ...
 $('#general_status_id').focus(function() {
     ...
     {		
			...
			$.post(base_url+"admin/general/change/statusTicket", { id:ticketid, status:status }, function(data){
				if(data.status == 1) {
...
// 	 }
 ...
 $('#priority').focus(function() {
     ...
     {		
    	 var ticketid = $("#ticketid").val();
         var priority = $("#priority").val();
 			$.post(base_url+"admin/general/change/changePriorityTicket", { id:ticketid, priority:priority }, function(data){
				if(data.status == 1) {
					alert("Priority Changed succesfully.");
				} else {
					$("#profile_response").show();
