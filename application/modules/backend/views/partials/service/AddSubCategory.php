							...
							<div class="panel-body">
                                ...
                                <div class="row">
									...
									<div class="col-md-6">
											...
											<select name="name" id="name" class="form-control">													<option value=""> Select SubCategory </option>													<?php foreach ($sub_categories as $subcategory) { ?>													<option value="<?php echo $subcategory['id'];?>,<?php echo $subcategory['name'];?>"><?php echo $subcategory['name'];?></option>													<?php } ?>											</select>
										</div>
										<div class="messageContainer"></div>
									</div>
