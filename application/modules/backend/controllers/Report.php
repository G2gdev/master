...
/*
	...
	public function downloadReport() {
		...
		$objWorksheet->setCellValueByColumnAndRow(8,$itemcnt,'Garage Name');
		...
		$objWorksheet->setCellValueByColumnAndRow(20,$itemcnt,'G2G Commission');
	...
	public function downloadVendorDetailsReport() {
		...
		$objWorksheet->setCellValueByColumnAndRow(1,$itemcnt,'Garage Name : '.$vendors[0]['garage_name']);
		...
		$objWorksheet->setCellValueByColumnAndRow(2,$itemcnt,'G2G Service Commission : '.$g2gservicecommission);
		$objWorksheet->setCellValueByColumnAndRow(3,$itemcnt,'G2G Spare Commission : '.$g2gsparecommission);
		$itemcnt = 4;
		...
		$objWorksheet->setCellValueByColumnAndRow(18,$itemcnt,'Total Bill');
		$objWorksheet->setCellValueByColumnAndRow(19,$itemcnt,'Amount Received');
		$objWorksheet->setCellValueByColumnAndRow(20,$itemcnt,'G2G Service Commission');
		$objWorksheet->setCellValueByColumnAndRow(21,$itemcnt,'Vendor Service Commission');
		$objWorksheet->setCellValueByColumnAndRow(22,$itemcnt,'G2G Spare Commission');
