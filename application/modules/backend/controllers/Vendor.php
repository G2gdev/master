...
public function newRestaurant() {
	...
	public function addRestaurant() {
		...
		$rest['password']  = mt_rand(100000, 999999); 
		$rest['status']  = 1; 
		//$rest['subcategory_id'] = $this->input->post('subcategory_id');
	...
	public function updateVen() {
		...
		//$service_id = $this->input->post('service_id');  // hide for post reason
	    ...
	    //$subcat_id = implode(",",$subcategory_id);
			...
			//print_r($ser_id);
			//$rest1['subcategory_id'] = $subcat_id;
		 //$rest1['service_id'] = $ser_id;
		/*	$id = $rest['id'];
			for($i = 0; $i < count($subcategory_id); $i++){
				$para = array();
				$para['subcategory_id'] = $subcategory_id[$i];
				$para['service_id'] = $service_id[$i];
				$para['restid'] = $id;
			    $paras[]=$para;
		...
		//print_r($params['rest1']);
		//print_r($params['billing']);
		//print_r($params['billingfields']);
