...
Class Service extends MX_Controller {
	...
	public function newService($category_id) {
		$this->load->library('zyk/ServiceLib');
		if($category_id == 0) {
			$subcategories = 'No records';
		}
		else {
			$subcategories = $this->servicelib->getSubCatId($category_id);
	...
	public function newSpare($category_id) {
		$this->load->library('zyk/ServiceLib');
		if($category_id == 0) {
			$subcategories = 'No records';
		}
	...
	public function brandbycatid() {
		...
		$this->load->library('zyk/ServiceLib', 'servicelib');
		$subcat = $this->servicelib->getBrandId($id);
		echo json_encode($subcat);
	}
