...
class Item extends MX_Controller {
	...
	public function searchItem($type,$cat,$brand,$model,$subcat) {
	...
	public function getItem($id,$type,$cat,$brand,$model,$subcat) {
		$this->load->library('zyk/ItemLib');
		//print_r($id);
		//print_r($rateid);
		$response = $this->itemlib->getItemById($id,$type,$cat,$brand,$model,$subcat);
		//print_r($response);
