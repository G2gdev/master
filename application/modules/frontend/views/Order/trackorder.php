...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
			...
			.division{
			  display:none;
				...
				.bg-c b {
                    color: rgb(246, 186, 51) !important;
				}
				.vi-img{
                    width: 40px;
                    margin-top: -7px;
				  ...
				  <a href="#" data-toggle="#div<?php echo $i ;?>" class="track-order">
				    <div class="head-sec">
				      <div class="row">
				        ...
				        <div class="col-sm-4 col-xs-4">
				        	<h3><?php echo $order['subcategory']?></h3>
						</div>				
				        <div class="col-sm-4 col-xs-4">
				          <h3>Total Amount : ₹<?php if(!empty($order['grand_total'])){ echo $order['grand_total']; } else { ?>0<?php
				           } ?>
				           <p>Garage Assigned - <?php echo $order['garage_name']; ?></p>
				         ...
				         <div class="row">
						   <div class="col-lg-3 col-xs-3 text-center" id="billing1<?php echo $order['orderid']?>">
							...
							<div class="col-lg-3 col-xs-3 text-center" id="track1<?php echo $order['orderid']?>">
							  <div class="nk-footer-text">
								 <p class="foterp bg-c" id="track<?php echo $order['orderid']?>" onclick="changecolor<?php echo $order['orderid']?>();"><b>Track Orders</b></p>
							  </div>
						   </div>
					 ...
					 <div class="col-lg-12 col-xs-12 text-center">
			           <div class="nk-footer-text">
					    ...
					    <div class="row roww" id="billing123<?php echo $order['orderid']?>" style="display:none">
							...
							<div class="container"
								style="background: #f5f5f7; padding-top: 5%;padding-bottom:8px">
								<div class="row">
									<div class="col-lg-2 col-xs-2 text-center">
										<div class="nk-footer-text">
											<!-- <img src="img/Thankucheck.png" class="img-responsive" /> -->
									...
									<div class="col-lg-2 col-xs-2  o-6">
										<div class="nk-footer-text">
											<!-- <img src="img/Thankucheck.png" class="img-responsive" /> -->
											<p class="foterp" style="font-weight: inherit;">Amount</p>
											<p class="foterp" style="font-weight: inherit;">Discount</p>
											<p class="foterp" style="font-weight: inherit;">Net Total</p>
											<p class="foterp" style="font-weight: inherit;">Adjustment</p> <br>
											<strong><p class="foterp" style="font-weight: inherit;">Grand Total</p></strong>
...
function generateInvoice(orderid) {
 ...
 <script>
 $('.heading-section .text-center .nk-footer-text p').on('click',function(){
	   $('.heading-section .text-center .nk-footer-text p').removeClass('bg-c');
	    $(this).addClass('bg-c');
	});
 </script>