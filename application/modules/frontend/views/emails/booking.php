									...
									<tr>
										...
										?>
												<tbody>
													...
													<tr>
														<td style="color:#000;padding-bottom:14px;font-family:Arial;font-size:16px;">
														    Garage2Ghar is happy to receive your appointment request. Our team will confirm the request shortly.
															<!--  your appointment has been confirmed and we will be there to serve you at the given time and address. Thanks for choosing Garage2Ghar.--> 
														</td>
													</tr>
													...
													<tr>
														<td style="color:#000;padding-bottom:2px;font-family:Arial;font-size:16px;">
															...
															<b>Address :</b> <span style="padding-left:2%;"><?php echo $data['locality'];?></span>
														</td>
													</tr>
													<tr>
														<td style="color:#000;padding-bottom:14px;font-family:Arial;font-size:16px;">
