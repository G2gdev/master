											...
											<td valign="top style=padding: 0px 13px 10px 14px;font-family:Arial">
												<table width="100% cellspacing=0 cellpadding=0">
													<tbody>
														...
														<tr>
														  <td style="color:#000;padding-bottom:14px;font-size:16px;font-family:Arial;">Use the following details to login into vendor app.
 															</td>

														 
														</tr>
														<tr>
														  <td style="color:#000;padding-bottom:14px;font-size:16px;font-family:Arial;">Username-<?php echo $user['name']; ?>
 															</td>
														...
														<tr>
															<td style="color:#000;padding-bottom:14px;font-size:16px;font-family:Arial;"> </td>
														</tr>
														<tr>
