...
<head>
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-137807951-1"></script>
    <script>
        window.dataLayer = window.dataLayer || [];
        function gtag(){dataLayer.push(arguments);}
        gtag('js', new Date());

        gtag('config', 'UA-137807951-1');
    </script>
...
<body>
    <section class="toppage" id="maindiv">
        <div class="container text-center">
            <div class="">
                <h3 class="shortroad">
            DOWNLOAD G2G MOBILE APP & GET INR 100 CASHBACK
             <a href='https://play.google.com/store/apps/details?id=info.azhar.garage_ghar&hl=en_IN&pcampaignid=MKT-Other-global-all-co-prtnr-py-PartBadge-Mar2515-1'><img alt='Get it on Google Play' src='https://play.google.com/intl/en_us/badges/images/generic/en_badge_web_generic.png' style="width:20%"/></a>
    ...
    <div class="container">
      ...
      <?php } else {?>
            ...
            <a href="#" style="padding-right: 28px; !important"><i class="fa fa-user">&nbsp;&nbsp;</i><?php echo $olousername ?></a>
              <ul class="dropdown-content spl-margin">
...
<!-- </div> -->
          ...
          <li><a href="#specialoffers">OUR OFFERS</a></li>
   ...
   <section class="about sec-special" id="about" style="background-image:url(<?php echo asset_url();?>images/img/world-map.png)">
    ...
    <div class="block block-pd-lg block-bg-overlay text-center" id="specialoffers" style="background-image:url(<?php echo asset_url();?>images/img/parallax-bg.jpg)" ;>
        <div class="col-md-12">
            <a class="numbring">
       <h2 class="stats-no numbringspan uppercase">Special PRICING</h2>
                ...
                <div class="col-md-4 col-xs-12">
                    <div class="pricing-table">
                        <div class="plan-name price-colorsele">
                            <h3 class="priceheader">Bike regular servicing</h3>
                            <div class="plan-price">
                                <div class="price-value">Rs 299* &#8212 Rs 1200*</div>
                            </div>
                        </div>
                        <div class="plan-list">
                            <ul class="">
                                <li><strong>Moped servicing  Rs 299* - Rs 449*</strong> </li>
                                <li><strong>Motorcycle servicing Rs 299* - Rs 499*</strong> </li>
                                <li><strong>High cc servicing Rs 699* - Rs 1199*</strong> </li>
                                <li><strong>Routine service, free delivery, in-depth analysis, periodic follow ups</strong> </li>
<!--                                 <li><strong>Free Delivery</strong></li> -->
                ...
                <div class="col-md-4 col-xs-12 vipmain">
                    <div class="pricing-table">
                        <div class="plan-name price-colorsele">
                            <h3 class="priceheader">Car regular servicing</h3>
                            <div class="plan-price">
                                <div class="price-value">Rs 800* &#8212 Rs 2000* </div>
                            </div>
                        </div>
                        <div class="plan-list">
                            <ul class="">
                                <li><strong>Hatchback servicing : Rs 800* - Rs 1500*</strong> </li>
                                <li><strong>Sedan servicing : Rs 800* - Rs 1800*</strong> </li>
                                <li><strong>SUV servicing : Rs 1000* - Rs 2000*</strong> </li>
                                <li><strong>Routine service, free delivery, in-depth analysis, periodic follow ups</strong> </li>
<!--                                 <li><strong>Free Delivery</strong></li> -->
                            </ul>
                        </div>
                ...
                <div class="col-md-4 col-xs-12">
                    <div class="pricing-table">
                        <div class="plan-name price-colorsele">
                            <h3 class="priceheader">Other car services</h3>
                            <div class="plan-price">
                                <div class="price-value">Rs 699* &#8212 Rs 1199* </div>
                            </div>
                        </div>
                        <div class="plan-list">
                            <ul class="">
                                <li><strong>Denting painting </strong> </li>
                                <li><strong>AC repair</strong> </li>
                                <li><strong>Car Spa</strong> </li>
                                <li><strong>Restorations</strong></li>
                            </ul>
                        </div>
                        <div class="plan-signup">
                            <a class="searchbtn" href="#maindiv">BOOK NOW</a></span>
...
//new api wihout billing
//$.getScript("https://maps.googleapis.com/maps/api/js?v=3.exp&libraries=places&callback=initMap&key=AIzaSyDacn0l-5z3rlZbUNNxpt21X8xnllCozN8"); 


//api with billing
//$.getScript("https://maps.googleapis.com/maps/api/js?v=3.exp&libraries=places&callback=initMap&key=AIzaSyDdmu0B0DFsGdD_IyTdTYbB29k2giXaf8U"); 
var autocomplete = "" ;
