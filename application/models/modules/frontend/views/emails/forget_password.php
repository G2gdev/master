										...
										<td valign="top style=padding: 0px 13px 10px 14px;font-family:Calibri,Calibri,sans-serif;">
											<table width="100% cellspacing=0 cellpadding=0 style=background: #f7f7f9; padding: 15px;">
												<tbody>
													<tr>
														<td style="padding-bottom:10px;">
															<h2 style="font-size:22px;font-weight:bold;color:#666666;font-family:'Calibri',sans-serif;font-weight:300;">  
																<span>Welcome</span> <?php echo $fname.' '.$lname?> !
															</h2>
														</td>
													</tr>
													<tr>
													...
													<tr>													
														<td style="color:#666666;font-size:16px;padding-bottom:17px;font-family:Calibri,sans-serif;font-weight:300;font-weight:2;">Regards, <br> Petpedia</td>
													</tr>
												</tbody>
											</table>
										</td>
