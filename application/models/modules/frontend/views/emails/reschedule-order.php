...
<div style="margin-left:15px;">
	...
	<br>
	<div id="main-content">since our mechanics are already occupied, have rescheduled your appointment on <?php echo $data['pickup_date']; ?> at <?php echo $data['pickup_slot']; ?>. Apologies for the inconvenience </div>
	<br>
