							...
							<div class="panel panel-default">
								<div class="panel-body">
									...
									<div class="row">
										...
										<div class="col-md-6">
								<div class="form-group" id="error-name">
							<div class="col-md-12">	<label class="control-label">Brand<span class='text-danger'>*</span></label>
								...
								<div class="row">
									...
									<div class="col-lg-6 margin-bottom-5">
										<div class="form-group" id="error-locality">
											...
											<div class="col-sm-10">
												<input type="text" class="form-control" id="locality11" name="locality" value="<?php echo $basic[0]['locality'];?>" <?php if($basic[0]['locality']!=''){ ?> readonly <?php } ?>   />
											</div>
											<div class="messageContainer col-sm-10"></div>
										</div>
									</div>
								...
								<div class="row">
									<div class="col-lg-6 margin-bottom-5">
										<div class="form-group" id="error-longitude">
											...
											<div class="col-sm-10">
												<input type="text" class="form-control" id="latitude" name="latitude" value="<?php echo $basic[0]['latitude'];?>" <?php if($basic[0]['latitude']!=''){ ?> readonly <?php } ?>    />
											</div>
											<div class="messageContainer col-sm-10"></div>
										</div>
									</div>
									<div class="col-lg-6 margin-bottom-5">
										<div class="form-group" id="error-longitude">
											...
											<div class="col-sm-10">
												<input type="text" class="form-control" id="longitude" name="longitude"	value="<?php echo $basic[0]['longitude'];?>" <?php if($basic[0]['longitude']!=''){ ?> readonly <?php } ?>  />
											</div>
											<div class="messageContainer col-sm-10"></div>
										</div>
									</div>
											...
											<div class="form-group" id="error-billing_cycle">
												...
												<div class="col-sm-10">
													<select name="billing_cycle" id="billing_cycle"
														...
														value="<?php if($cycle) {echo date('d-m-Y',strtotime($cycle[0]['from_date']));}else{echo date('d-m-Y'); }?>"
											...
											<div class="form-group" id="error-invoice_notify_mobile">
												...
												<div class="col-sm-10">
													<input type="text" id="gateway_charge"
														...
														value="<?php if($gateway){ echo date('d-m-Y',strtotime($gateway[0]['from_date']));}else{echo date('d-m-Y'); }?>"
