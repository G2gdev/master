		...
		<div class="col-lg-7" style="padding:0px 5px;">
        	<div class="panel panel-default">
	           ...
	           <!--     	<?php //if(!empty($order['delivery_date'])) { ?>
			 	...
			 	<?php if($order['status'] > 1) { ?>
			<div class="panel panel-default">
			<form action="" method="post" name="addrateitems" id="addrateitems" >
            	<div class="panel-heading">
                	<b>Order Items</b>
               	...
               	<div class="panel-body" style="padding:1px;">
					...
					<input type="hidden" name="orderidhidden" id="orderidhidden" value="<?php echo $order['orderid'];?>">
               		<?php foreach($items as $item) { ?>
						...
						<div class="col-sm-2"><!-- <input type="checkbox" name="is_checked[]" value="<?php echo $item['is_checked'];?>" <?php if($item['is_checked'] == 0){ ?> <?php } else { ?>checked <?php } ?>/>-->
						<?php if($item['service']==1) { ?><span style="font-weight:500;"><?php echo Service;?></span><input type="hidden" name="itemnm[]" value="<?php echo Service;?>">  <?php } else { ?><span style="font-weight:500;"><?php echo Spare;?></span><input type="hidden" name="itemnm[]" value="<?php echo Spare;?>"><?php }?></div>
	               			<div class="col-sm-3"><span style="font-weight:500;"><?php echo $item['service_name'];?></span><br><span style="color:red"><?php if($item['is_checked'] == 0){ ?>(waiting for approval)<?php }else if($item['is_checked'] == 1){ ?>(Approved)<?php }else{ ?>(Rejected)<?php } ?></span><input type="hidden" name="itemnm[]" value="<?php echo $item['service_name'];?>"> </div>
		               		<div class="col-sm-2"><?php if($item['priority']==1) { ?><span style="font-weight:500;"><?php echo "High";?></span><input type="hidden" name="itempriority[]" value="<?php $item['priority'];?>">  <?php } else if($item['priority']==2){ ?><span style="font-weight:500;"><?php echo "Medium";?></span><input type="hidden" name="itempriority[]" value="<?php $item['priority']; ?>"><?php } else { ?><span style="font-weight:500;"><?php echo "Low";?></span><input type="hidden" name="itempriority[]" value="<?php echo $item['priority']; ?>"><?php }?></div>
               		...
               		<!-- <div class="col-sm-12" style="padding:5px 0px;">
               			<input type="button" name="approvalUpdate" id="invoice" value="Update" class="btn btn-primary"/>
               		</div>-->
               		<div class="col-sm-12" style="padding:5px 0px;">
               			<div class="col-sm-6">
               			</div>
          		...
          		<div id="orderitems">
              		...
              		<div class="row" style="padding:10px 5px;background-color:#f2f2f2;border-bottom:1px solid #ccc;" id="rowitem-1">
                  		<div class="row form-group pqr">
                  			...
                  			<div class="col-sm-3">
                       			<select name="itemtype[]" id="itemtype-1" class="form-control itemname">
                       		...
                       		<div class="col-sm-3">
                       			<input type="text" class="form-control itemname" name="itemname[]" id="itemname-1" value="" placeholder="Service Name" autocomplete="off"/>
                       		</div>
                       		<div class="col-sm-1">
                       			<input type="text" class="form-control itemname" name="itemtax[]" id="itemtax-1" value="" placeholder="Tax" readonly/>
                       		</div>
                       		<div class="col-sm-2">
          		...
          		<div id="eorderitems">
              		...
              		<div class="row" style="padding:10px 5px;background-color:#f2f2f2;border-bottom:1px solid #ccc;" id="erowitem-<?php echo $key;?>">
                  		<div class="row form-group pqr">
                  			...
                  			<select name="itemtype[]" id="eitemtype-<?php echo $key;?>" class="form-control itemname">
                       			<!-- <option value=""><?php if($item['service']==1){echo "Service";} else {echo "Spare";}?></option> -->
                       			<option value="1" <?php if($item['service']==1){echo "selected";}?>>Service</option>
                       			<option value="2" <?php if($item['service']==2){echo "selected";}?>>Spare</option>
                       			</select>
                       				</div>
                       		<div class="col-sm-3">
                       			<input type="text" class="form-control itemname" name="itemname[]" id="eitemname-<?php echo $key;?>" value="<?php echo $item['service_name'];?>" placeholder="Enter Service Name" autocomplete="off"/>
                       		</div>
                       	    <div class="col-sm-1">
                       			<input type="text" class="form-control itemname" name="itemtax[]" id="eitemtax-<?php echo $key;?>" readonly value="<?php echo $item['tax'];?>" placeholder="Enter Service Name" autocomplete="off"/>
                       		</div>
                       		<div class="col-sm-2">
                       		...
                       		<div class="col-sm-2">
                       			<select name="priority[]" id="priority-1" class="form-control itemname">
	                       			<option value="">Select Priority</option>
	                       			<option value="1" <?php if($item['priority']==1){echo "selected";}?>>High</option>
	                       			<option value="2" <?php if($item['priority']==2){echo "selected";}?>>Medium</option>
	                       			<option value="3" <?php if($item['priority']==3){echo "selected";}?>>Low</option>
                       			</select>
                       		</div>
...
function assignGarage(orderid) {
    ...
    for (i = 1; i < x.length; i++) {
 	...
 	if($("#vendor_id").val() != "") {
		ajaxindicatorstart("Please hang on.. while we assign order ..");
		$.get(base_url+"admin/order/assigndelivery/"+orderid,{ vendor_id: $("#vendor_id").val(),other_vendor: txt}, function(data){
			ajaxindicatorstop();
			alert(data.message);
			window.location.reload();
		},'json');
...
function updateassignGarage(orderid) {
    ...
    for (i = 1; i < x.length; i++) {
 	...
 	if($("#vendor_idupdate").val() != "") {
		ajaxindicatorstart("Please hang on.. while we assign order ..");
		$.get(base_url+"admin/order/updateassigndelivery/"+orderid,{ vendor_id: $("#vendor_idupdate").val(),other_vendor: txt}, function(data){
			ajaxindicatorstop();
			alert(data.message);
			window.location.reload();
		},'json');
...
<?php foreach ($items as $key=>$item) { ?>
	...
	$("#eitemtype-1").change(function() {
		//alert("hi");
		var a=$("#eitemtype-1").val();
		var b=$("#category_id").val();
		var c=$("#brand_id").val();
		var d=$("#model_id").val();
		var e=$("#subcategory_id").val();
...
function addMoreItems() {
	...
	var html = '<div class="row" style="padding:10px 5px;background-color:#f2f2f2;border-bottom:1px solid #ccc;" id="rowitem-'+rows+'">'+
		...
		'<div class="col-sm-3">'+
		'<select class="form-control itemname" name="itemtype[]" id="itemtype-'+rows+'"><option value="">Select Type</option><option value="1">Service</option><option value="2">Spare</option></select>'+
	    '</div>'+
		'<div class="col-sm-3">'+
			'<input type="text" class="form-control itemname" name="itemname[]" id="itemname-'+rows+'" value="" placeholder="Service Name" autocomplete="off"/>'+
		'</div>'+
		'<div class="col-sm-1">'+
...
function eaddMoreItems() {
	...
	var html = '<div class="row" style="padding:10px 5px;background-color:#f2f2f2;border-bottom:1px solid #ccc;" id="erowitem-'+rows+'">'+
		...
		'<div class="col-sm-3">'+
		'<select class="form-control itemname" name="itemtype[]" id="eitemtype-'+rows+'"><option value="">Select Type</option><option value="1">Service</option><option value="2">Spare</option></select>'+
	    '</div>'+
		'<div class="col-sm-3">'+
