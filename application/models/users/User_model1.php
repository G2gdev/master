...
class User_model extends CI_Model {
	...
	public function getlastOrder($data) 
   	{
   		$this->db->select ('a.orderid,a.ordercode,a.pickup_date,a.category_id as vehicaltype,b.garage_name,d.name as subcategory');
	...
	{
		$this->db->select ('a.orderid,a.ordercode,a.pickup_date,a.order_amount,a.discount,a.net_total,a.adjustment,a.grand_total,a.category_id as vehicaltype,b.garage_name,d.name as subcategory');
		$this->db->from ( TABLES::$ORDER.' AS a');
		$this->db->join ( TABLES::$RESTAURANT.' AS b','a.vendor_id=b.id','left' );
		//$this->db->join ( TABLES::$INVOICE.' AS c','a.orderid=c.orderid','left' );
		$this->db->join ( TABLES::$MENU_MAIN_SUBCATEGORY.' AS d','a.subcategory_id=d.id','left' );
